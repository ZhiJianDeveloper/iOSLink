...
/**
 @brief Return the current iOS netmask on the wlan interface.255.255.255.0
 */
+ (NSString *)getNetMask;

/**
 @brief Return the current iOS broadcast address on the wlan interface.192.168.1.255
 */
+ (NSString *)getBroadcastAddress;

/**
 @brief Return the current iOS gateway address on the wlan interface.192.168.1.1
 */
